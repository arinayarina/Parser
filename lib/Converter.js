...
class Converter {
    ...
    convertReferenceLable(tag){
        ...
        if(title.length > 0) {
            this.html = this.html.concat("<a href=\"" + link + "\" title=\"" + title  + "\">");
        } else {
            this.html = this.html.concat("<a href=\"" + link  + "\">");
        }
    ...
    convertImage(image) {
        if(image.title.length > 0) {
            this.html = this.html.concat("<img src='", image.link, "' alt='", image.alt, "' title='", image.title, "'/>");
        } else {
            this.html = this.html.concat("<img src='", image.link, "' alt='", image.alt, "'/>");
        }
    }
    ...
    convertLink(link) {
        if(link.title.length > 0) {
            this.html = this.html.concat("<a href=\"" + link.link + "\" title=\"" + link.title  + "\">");
        } else {
            this.html = this.html.concat("<a href=\"" + link.link  + "\">");
        }
